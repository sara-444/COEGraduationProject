...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_GRAMMAR = 4,                    /* GRAMMAR  */
  YYSYMBOL_IMPORT = 5,                     /* IMPORT  */
  YYSYMBOL_PUBLIC = 6,                     /* PUBLIC  */
  YYSYMBOL_TOKEN = 7,                      /* TOKEN  */
  YYSYMBOL_RULENAME = 8,                   /* RULENAME  */
  YYSYMBOL_TAG = 9,                        /* TAG  */
  ...
  YYSYMBOL_grammar = 21,                   /* grammar  */
  YYSYMBOL_header = 22,                    /* header  */
  YYSYMBOL_jsgf_header = 23,               /* jsgf_header  */
  YYSYMBOL_grammar_header = 24,            /* grammar_header  */
  YYSYMBOL_import_header = 25,             /* import_header  */
  YYSYMBOL_import_statement = 26,          /* import_statement  */
  YYSYMBOL_rule_list = 27,                 /* rule_list  */
  YYSYMBOL_rule = 28,                      /* rule  */
  YYSYMBOL_alternate_list = 29,            /* alternate_list  */
  YYSYMBOL_rule_expansion = 30,            /* rule_expansion  */
  YYSYMBOL_tagged_rule_item = 31,          /* tagged_rule_item  */
  YYSYMBOL_rule_item = 32,                 /* rule_item  */
  YYSYMBOL_rule_group = 33,                /* rule_group  */
  YYSYMBOL_rule_optional = 34,             /* rule_optional  */
  YYSYMBOL_rule_atom = 35                  /* rule_atom  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "HEADER", "GRAMMAR",
  "IMPORT", "PUBLIC", "TOKEN", "RULENAME", "TAG", "WEIGHT", "';'", "'='",
  "'|'", "'('", "')'", "'['", "']'", "'*'", "'+'", "$accept", "grammar",
  "header", "jsgf_header", "grammar_header", "import_header",
  "import_statement", "rule_list", "rule", "alternate_list",
  "rule_expansion", "tagged_rule_item", "rule_item", "rule_group",
  "rule_optional", "rule_atom", YY_NULLPTR
};
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, void* yyscanner, jsgf_t *jsgf)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (yyscanner);
                 ...
                 yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, void* yyscanner, jsgf_t *jsgf)
{
  ...
  yy_symbol_value_print (yyo, yykind, yyvaluep, yyscanner, jsgf);
  YYFPRINTF (yyo, ")");
}
...
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp,
                 int yyrule, void* yyscanner, jsgf_t *jsgf)
{
  ...
  for (yyi = 0; yyi < yynrhs; yyi++)
    {
      ...
      yy_symbol_print (stderr,
                       ...
                       &yyvsp[(yyi + 1) - (yynrhs)], yyscanner, jsgf);
      YYFPRINTF (stderr, "\n");
    }
}
...
do {                                    \
  if (yydebug)                          \
    yy_reduce_print (yyssp, yyvsp, Rule, yyscanner, jsgf); \
} while (0)
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, void* yyscanner, jsgf_t *jsgf)
{
  YY_USE (yyvaluep);
  YY_USE (yyscanner);
  YY_USE (jsgf);
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  YY_ACCESSING_SYMBOL (yystate), yyvsp, yyscanner, jsgf);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  YY_ACCESSING_SYMBOL (+*yyssp), yyvsp, yyscanner, jsgf);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
